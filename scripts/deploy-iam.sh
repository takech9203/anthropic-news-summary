#!/usr/bin/env bash
# Deploy OIDC provider and IAM role for Anthropic News Summary CI/CD.
#
# Usage:
#   # GitHub Actions (role: GitHubActions-AnthropicNewsSummary, stack: anthropic-news-summary-github-iam)
#   ./scripts/deploy-iam.sh -p github -o myorg
#
#   # GitLab CI (role: GitLabCI-AnthropicNewsSummary, stack: anthropic-news-summary-gitlab-iam)
...
PLATFORM=""
ORG_OR_GROUP=""
REPO_OR_PROJECT="anthropic-news-summary"
OIDC_PROVIDER_ARN=""
...
Optional:
  -r, --repo REPO             Repository/project name (default: anthropic-news-summary)
  -n, --role-name NAME        IAM role name (default: GitHubActions-AnthropicNewsSummary or GitLabCI-AnthropicNewsSummary)
  -s, --stack-name NAME       CloudFormation stack name (default: anthropic-news-summary-github-iam or anthropic-news-summary-gitlab-iam)
...
if [[ "$PLATFORM" == "github" ]]; then
  [[ -z "$ROLE_NAME" ]] && ROLE_NAME="GitHubActions-AnthropicNewsSummary"
  [[ -z "$STACK_NAME" ]] && STACK_NAME="anthropic-news-summary-github-iam"
  ...
  [[ -z "$ROLE_NAME" ]] && ROLE_NAME="GitLabCI-AnthropicNewsSummary"
  [[ -z "$STACK_NAME" ]] && STACK_NAME="anthropic-news-summary-gitlab-iam"
...
echo "=== Anthropic News Summary IAM Setup ==="
echo "Platform: ${LABEL}"
